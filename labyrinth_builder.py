...
def labyrinth_builder(labyrinth_number_of_levels: int, 
    ...
    while(len(labyrinth_level_list) < 
          labyrinth_number_of_levels):
        labyrinth_level: str = labyrinth_level_designer(labyrinth_number_of_rows, 
                                                        labyrinth_number_of_columns)
        labyrinth_level_list.append(labyrinth_level)
    
    labyrinth_level_list = labyrinth_set_start_and_exit(labyrinth_level_list, 
...
def labyrinth_level_designer(labyrinth_number_of_rows: int, 
                             labyrinth_number_of_columns: int) -> str:
    """
    ...
    labyrinth_level: str            = np.chararray((labyrinth_number_of_rows, 
                                                    labyrinth_number_of_columns), 
                                                    unicode = True)    
...
def labyrinth_set_start_and_exit(labyrinth_level_list: str, 
                                 labyrinth_number_of_rows: int, 
...
def labyrinth_level_list_output(labyrinth_number_of_levels: int, 
                                labyrinth_level_list: list) -> None:
    """
